<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GerenciadorPedidos.aspx.cs" Inherits="E_CommerceFood.admin.GerenciadorPedidos" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Gerenciador de Pedidos - Admin</title>
...
<body style="padding-top: 40px;">
    <form id="form1" runat="server">
        ...
        <!-- CONTEÚDO -->
        <div class="container mt-5 pt-4" style="padding-left: 20px; padding-right: 20px;">

            <asp:GridView ID="gvPedidos" runat="server" AutoGenerateColumns="false" OnRowCommand="gvPedidos_RowCommand" OnRowDataBound="gvPedidos_RowDataBound" CssClass="table table-striped">
                <Columns>
                    <asp:BoundField DataField="Id" HeaderText="ID" />
                    <asp:BoundField DataField="IdUsuario" HeaderText="Usuário" />
                    <asp:BoundField DataField="DataPedido" HeaderText="Data" DataFormatString="{0:g}" />
                    ...
                    <asp:TemplateField HeaderText="Status">
                        <ItemTemplate>
                            <asp:DropDownList ID="ddlStatus" runat="server">
                                ...
                                <asp:ListItem Text="Em Preparação" Value="Em Preparação" />
                                <asp:ListItem Text="À Caminho" Value="A Caminho" />
                    ...
                    <asp:TemplateField HeaderText="Ações">
                        <ItemTemplate>
                            <asp:Button ID="btnAtualizar" runat="server" Text="Atualizar" CommandName="AtualizarStatus" CommandArgument='<%# Eval("Id") %>' CssClass="btn btn-primary" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
